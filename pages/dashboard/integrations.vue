...
<template>
  <div class="w-full py-32 max-w-app mx-auto">
    <div class="max-w-[800px] p-20 rounded-lg bg-surface-default shadow-2 grid">
      <h2 class="text-heading font-semibold">Available integrations</h2>

      <p class="my-20">
        We currently don't have any integrations available but we're working on
        making some available for you in due time. Kindly use the button below
        to recommend an integration you'd like to use with Crowd.
      </p>
