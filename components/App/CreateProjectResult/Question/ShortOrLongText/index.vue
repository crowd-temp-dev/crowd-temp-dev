...
import { UpdateAnswerPayload } from '~/store/projectSuite/viewResult'

type Numbering = `${number}${string}`

export default defineComponent({
  name: 'AppProjectResultsDesignSurveyQuestionShortOrLongText',
        ...
        .map((user, index) => {
          ...
          return {
            ...
            toggleFavourite: async () => {
              ...
              await root.$store.dispatch('projectSuite/viewResult/updateAnser', {
                followUpAlpha: alpha,
